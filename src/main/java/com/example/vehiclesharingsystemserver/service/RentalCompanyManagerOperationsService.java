...
public class RentalCompanyManagerOperationsService {
    ...
    public RentalCompanyManagerOperationsService(RentalCompanyManagerRepository rentalCompanyManagerRepository, CompanyRepository companyRepository, VehicleRepository vehicleRepository, VehiclePendingUpdateRepository vehiclePendingUpdateRepository, AccountRepository accountRepository, RentalSessionRepository rentalSessionRepository, AuthenticationManager authenticationManager, JwtService jwtService, DTOConverter dtoConverter) {
