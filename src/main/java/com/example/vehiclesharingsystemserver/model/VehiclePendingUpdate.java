...
@Entity
@Table(name = "pending_vehicles_changes")
public class VehiclePendingUpdate {
    ...
    public VehiclePendingUpdate(String vin, String registrationNumber, String manufacturer, String model, int rangeLeftInKm, int yearOfManufacture,
